...
def _mock_abdominal_pain(id, created, data):
    if id == 600304:
        logging.info("Mocking version 2.8 for id 600304 with public_transportation_last_week = false")
        data["public_transportation_last_week"] = False
        data["version"] = "2.8.0"
    elif id == 676580:
        logging.info("Mocking version 2.8 for id 676580 with public_transportation_last_week = true , public_transportation_bus = true")
...
Flow(
    ...
    printer(fields=[
        "__id", "__created", "version", "public_transportation_last_week", "public_transportation_bus", "public_transportation_train", "public_transportation_taxi", "public_transportation_other"
    ]),
).process()
Flow(
    ...
    test_corona_bot_answers(
        lambda row: [str(row[k]) for k in ["questionare_version", "public_transportation_last_week", "public_transportation_bus", "public_transportation_train", "public_transportation_taxi", "public_transportation_other"]],
        {
            #                                                               last weeek      bus      train      taxi      other
            "94": ["corona_bot_answers_22_3_2020_with_coords",     "0.1.0", "",             "",      "",        "",       ""],
            "180075": ["corona_bot_answers_25_3_2020_with_coords", "1.0.1", "",             "",      "",        "",       ""],
            "600304": ["corona_bot_answers_20_4_2020_with_coords", "2.8.0", "0",            "0",     "0",       "0",      "0"],
            "600895": ["corona_bot_answers_20_4_2020_with_coords", "2.6.0", "",             "",      "",        "",       ""],
            "676580": ["corona_bot_answers_29_4_2020_with_coords", "2.8.0", "1",            "1",     "0",       "0",      "0"],
            "676581": ["corona_bot_answers_29_4_2020_with_coords", "2.7.4", "",             "",      "",        "",       ""],
            "701508": ["corona_bot_answers_2_5_2020_with_coords",  "2.7.6", "",             "",      "",        "",       ""],
        }
    ),
    printer(fields=[
        "timestamp", "id", "questionare_version", "public_transportation_last_week", "public_transportation_bus", "public_transportation_train", "public_transportation_taxi", "public_transportation_other"
    ])
).process()
